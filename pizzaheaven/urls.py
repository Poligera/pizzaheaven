...
urlpatterns = [
    ...
    path('order/', views.order, name='order'), # order pizza route ("http://localhost:8000/order")

    path('order/<int:pk>/', views.edit_order, name='edit_order') # UPDATE (edit) order in db
